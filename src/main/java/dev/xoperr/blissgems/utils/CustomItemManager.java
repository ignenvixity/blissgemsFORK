...
public class CustomItemManager {
    ...
    static {
        ...
        registerItem("astra_gem_t1", Material.ECHO_SHARD, 1001, "§d§lASTRA GEM", List.of(
            ...
            "",
            "§a🌟 §a§lPASSIVES",
            "§7- 10% of incoming attacks will pass through you",
            "",
            "§b🌟 §b§lABILITY",
            "§7- Dimensional Drift",
            "",
        ...
        registerItem("life_gem_t1", Material.ECHO_SHARD, 1004, "§d§lLIFE GEM", List.of(
            ...
            "§7- Heal 0.3 hearts every 5 seconds",
            "§7- Golden apples give +2 hearts",
            "",
            "§b🌟 §b§lABILITY",
            "§7- Rapid Healing",
            "",
        ...
        registerItem("life_gem_t2", Material.ECHO_SHARD, 2004, "§d§lLIFE GEM", List.of(
            ...
            "§a🌟 §a§lPASSIVES",
            "§7- Immune to withering",
            "§7- Heal 0.5 hearts every 5 seconds",
            "§7- Golden apples give +4 hearts",
            "",
            "§b🌟 §b§lABILITY",
            "§7- Rapid Healing",
            "",
